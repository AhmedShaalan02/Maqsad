...
export const modules = [
  ...
  },
  {
    id: 'seerah',
    name: 'Seerah',
    description: 'The life of the Prophet ﷺ — a chronological journey from birth to the farewell, with deep dives into major events',
    accent: '#4A6741',
    icon: <TimelineIcon />,
  },
  {
  ...
  },
  {
    ...
    description: 'Aqeedah, Tafseer methodology, Usool al-Fiqh, history of Islamic scholarship, and Seerah of the Companions',
    accent: '#C4973A',
    icon: <LampIcon />,
  },
  {
    id: 'burhan',
    name: 'Burhan',
    description: 'A logical, philosophical and spiritual case for Islam — built for the honest skeptic. Follow the evidence.',
    accent: '#1C1410',
    icon: <AtomIcon />,
  },
]
